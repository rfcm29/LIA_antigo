        ...
        <ul class="nav_list">
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="espacoSubmenu">
                    ...
                    <li>
                        <a href="/admin/espacoLia" class="nav_link">
                            <i class='bx bxs-user-detail nav_icon'></i>
                            <span class="nav_name">Ver Espaços</span>
                        </a>
                    </li>

                    <li>
                        <a href="/admin/reservaEspaco" class="nav_link">
                            <i class='bx bxs-user-detail nav_icon'></i>
                            <span class="nav_name">Ver Reservas</span>
                        </a>
                    </li>
